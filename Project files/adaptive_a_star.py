...
def calc():
    ...
    # path_smaller_g, expanded_nodes = adaptive_a_star(maze, break_ties_smaller_g=True)
    ...
    path_larger_g, expanded_nodes = adaptive_a_star(maze, break_ties_smaller_g=False)
